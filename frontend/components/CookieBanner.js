      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-elevated border border-gray-200 p-5 flex flex-col sm:flex-row items-center gap-4">
        ...
        <div className="flex gap-3 flex-shrink-0">
          ...
          <button
            ...
            className="px-5 py-2.5 text-sm font-semibold text-white bg-blue-600 rounded-button hover:bg-blue-700 shadow-md hover:shadow-lg transition-all duration-200"
          >
            {t('cookies.accept')}
          </button>
        </div>
