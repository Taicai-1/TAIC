...
class GmailPlugin(BasePlugin):
    ...
    def get_actions(self):
        return {
            "send_email": ActionDefinition(
                ...
                parameters_schema=schemas.SEND_EMAIL,
                display_name="Send Email",
                icon="send",
                side_effect=True,
            ),
            "reply_email": ActionDefinition(
                name="reply_email",
                description="Reply to an existing email thread",
                parameters_schema=schemas.REPLY_EMAIL,
            ...
            "search_emails": ActionDefinition(
                ...
                parameters_schema=schemas.SEARCH_EMAILS,
    ...
    def execute(self, action_name, args, credentials):
        action_map = {
            ...
            "reply_email": actions.reply_email,
            "search_emails": actions.search_emails,
        }
