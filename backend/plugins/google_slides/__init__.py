...
class GoogleSlidesPlugin(BasePlugin):
    ...
    def get_actions(self):
        return {
            "create_presentation": ActionDefinition(
                name="create_presentation",
                description="Create a new Google Slides presentation with optional slides",
                parameters_schema=schemas.CREATE_PRESENTATION,
                display_name="Create Presentation",
                icon="plus-square",
                side_effect=True,
            ),
            "add_slide": ActionDefinition(
                name="add_slide",
                description="Add a new slide to an existing presentation",
                parameters_schema=schemas.ADD_SLIDE,
