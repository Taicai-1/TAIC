    ...
    def get_actions(self):
        return {
            "create_folder": ActionDefinition(
                ...
                parameters_schema=schemas.CREATE_FOLDER,
            ...
            "move_file": ActionDefinition(
                ...
                parameters_schema=schemas.MOVE_FILE,
                display_name="Move File",
                icon="folder-input",
                side_effect=True,
            ),
            "share_file": ActionDefinition(
                name="share_file",
                description="Share a file or folder with another user by email",
                parameters_schema=schemas.SHARE_FILE,
            ...
            "search_files": ActionDefinition(
                ...
                parameters_schema=schemas.SEARCH_FILES,
