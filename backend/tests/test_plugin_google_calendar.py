...
class TestGoogleCalendarPlugin:
    ...
    def test_create_event(self, mock_build):
        ...
        mock_service.events().insert().execute.return_value = {"id": "evt123", "htmlLink": "https://calendar.google.com/evt123"}
        from plugins.google_calendar import GoogleCalendarPlugin
        p = GoogleCalendarPlugin()
        result = p.execute("create_event", {"title": "Meeting", "start": "2026-06-04T10:00:00+02:00", "end": "2026-06-04T11:00:00+02:00"}, MagicMock())
